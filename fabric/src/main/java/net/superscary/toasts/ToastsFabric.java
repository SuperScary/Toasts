...
public class ToastsFabric implements ClientModInitializer {
    private static final Logger LOGGER = LoggerFactory.getLogger(ToastsFabric.class);
    ...
    private void renderToast(GuiGraphics graphics, CustomToast toast) {
        int width = 160;
        int height = 32;
